...
export const ja: SiteContent = {
  ...
  about: {
    title: "自己紹介",
    body: [
      "こんにちは、呉雨諾です。中国・北京出身で、現在は東京大学大学院の博士課程に在籍しています。空間情報学、建築、都市計画、ランドスケープを横断するバックグラウンドを持っています。明るく前向きな性格で、スポーツや新しい知識を学ぶこと、時代の変化を捉えることが好きです。こうした好奇心が、分野を横断して学び、研究を続ける原動力になっています。",
      "修士研究では、衛星埋め込み表現、自治体調査データ、行政区域データを統合し、深層学習を用いて空き家数を推定しました。",
      "博士課程では、空間情報を用いた建物単位の時空間モデリングの自動化に取り組み、住宅変化と都市衰退のプロセスをより精緻に把握することを目指しています。",
      "自分の研究にも日々の生活にも強い愛着を持ち、社会にとって意味のある仕事を形にしていきたいと考えています。",
    ],
  },
  research: {
    title: "研究",
    ...
    items: [
      {
        ...
        description: "修士研究",
        points: [
          "衛星埋め込み表現、自治体調査データ、行政区域データを使用しました。",
  ...
  activities: {
    ...
    items: [
      ...
      {
        institution: "スポーツ・アウトドア",
        program: "女子バスケットボール 8 年、スキー、フィットネス、ハイキングなど",
        period: "ライフワーク",
      },
    ],
  },
